@extends('layouts.app')
  ...
  <div style=" background-color: #424242; background-image: linear-gradient(90deg, #383838 0%, #3b3b3b 100%);min-height: 85vh;">
      <br>
                                  ...
                                  <div class="media"><img src="https://bootstrapious.com/i/snippets/sn-chat/avatar.svg" alt="user" width="50"  class="rounded-circle">
                                      <div class="media-body ml-4">
                                          <div class="d-flex align-items-center justify-content-between mb-1">
                                              <h6 class="mb-0">Ahmed Ashraf</h6> <small class="small font-weight-bold">25 Dec</small>
                                          </div>
                                  ...
                                  <div class="media"><img src="https://bootstrapious.com/i/snippets/sn-chat/avatar.svg" alt="user" width="50" class="rounded-circle">
                                      <div class="media-body ml-4">
                                          <div class="d-flex align-items-center justify-content-between mb-3">
                                              <h6 class="mb-0">Ahmed Ashraf</h6><small class="small font-weight-bold">21 Aug</small>
                                          </div>
                                          <p class="font-italic text-muted mb-0 text-small" style="font-size: 0.9rem;">Lorem ipsum dolor sit amet,  consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p>
                                      </div>
                                  </div>
                              </a>
                              ...
                              <div class="media w-50 mb-3">
                                  ...
                                  <div class="media-body ml-3">
                                      <div class="bg-light rounded py-2 px-3 mb-2">
                                          <p class="text-small mb-0 text-muted" style="font-size: 0.9rem;">aaaaaaaaaa</p>
                                      </div>
                                      <p class="small text-muted">aaaaaaaa</p>
                                  </div>
                              </div>
                              ...
                              <div class="media w-50 ml-auto mb-3">
                                  <div class="media-body">
                                      <div class="bg-primary rounded py-2 px-3 mb-2">
                                          <p class="text-small mb-0 text-white" style="font-size: 0.9rem;">aaaaaaaa</p>
                                      </div>
                                      <p class="small text-muted">caaaaa</p>
                                  </div>
                              </div>
                          </div>
...
{{--                      @endforeach--}}
                  ...
                  <!-- Typing area -->
                  <form action="{{ route('messages.store') }}" class="bg-light" method="post">
                      @csrf
